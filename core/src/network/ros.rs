...
use serde_json; 
use crate::pipeline::{populate_gdp_struct_from_bytes, proc_gdp_packet, construct_gdp_forward_from_bytes, construct_gdp_advertisement_from_bytes};
...
pub async fn ros_listener(rib_tx: Sender<GDPPacket>, channel_tx: Sender<GDPChannel>) {
    ...
    proc_gdp_packet(node_advertisement,  // packet
